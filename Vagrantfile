...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "app" do  |app|
	...
	# app.vm.provision "file", source: "catalog/node.service", destination: "/tmp/node.service"
	# app.vm.provision "shell", path: "catalog/node.sh", privileged: true
  end
...
# 	web.vm.provision "shell", path: "nginx.sh", privileged: true
#   end
